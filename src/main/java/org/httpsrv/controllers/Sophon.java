...
@RestController
@RequestMapping(value = "downloader/sophon/api", produces = "application/json")
public class Sophon implements org.httpsrv.ResponseHandler {
     ...
     */
    @RequestMapping(value = "getParamsConfig")
...
/// TODO Implement: https://sg-public-api.hoyoverse.com/downloader/sophon/api/getABTest
/// TODO Implement: https://sg-public-api.hoyoverse.com/downloader/sophon_chunk/api/getBuild